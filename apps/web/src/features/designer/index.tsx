...
import { BathroomCanvas } from '@tilevista/three-core';
import { Settings, Save, LayoutGrid, Ruler, Plus, Sparkles } from 'lucide-react';
  ...
  return (
    <div className="flex flex-col lg:flex-row h-screen bg-slate-950 text-white overflow-hidden p-6 gap-6 font-outfit">
      ...
      <div className="flex-1 h-[60vh] lg:h-auto relative">
        <BathroomCanvas>
          {/* 3D R3F objects layers go inside this container on compilation */}
        </BathroomCanvas>
      </div>

      {/* Editor Panel Controls Side Panel */}
